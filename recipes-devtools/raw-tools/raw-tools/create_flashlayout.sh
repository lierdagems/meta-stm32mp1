...
then
	...
	FLASHLAYOUT_rawname=$(basename $FLASHLAYOUT_filename | sed -e "s/tsv/raw/")
	FLASHLAYOUT_infoname=$(basename $FLASHLAYOUT_filename | sed -e "s/tsv/how_to_update.txt/")
